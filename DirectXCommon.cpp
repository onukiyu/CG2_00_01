...
Microsoft::WRL::ComPtr<ID3D12Resource> DirectXCommon::CreateDepthStencilTextureResource(D3D12_DESCRIPTOR_HEAP_TYPE heapType, UINT numDescriptors, bool shaderVisible)
{
	//12ページ
	//生成するResourceの設定
	D3D12_RESOURCE_DESC resourceDesc{};
...
{
	return GetCPUDescriptorHandle(srvdescriptorHeap, descriptorSize, index);
}

D3D12_GPU_DESCRIPTOR_HANDLE DirectXCommon::GetSRVGPUDescriptorHandle(uint32_t index)
{
	return GetGPUDescriptorHandle(srvdescriptorHeap, descriptorSize, index);
}
